...
public:
 Messenger();
  ...
  void setBufferString(char *newBuffer); // Added by Pietro Moscetta
  char* readBufferString(); // Added by Pietro Moscetta
  ...
  char buffer[MESSENGERBUFFERSIZE]; // Buffer that holds the data. Moved from private section in that public by Marco Gagliarducci
